...
: ${AMENT_CURRENT_PREFIX:="/home/yuan/rm/code/Ros/my_ros2_control/install/gimbal_controller"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/gimbal_controller/environment/library_path.sh"
